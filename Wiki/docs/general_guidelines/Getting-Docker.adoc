...
TIP: Want to learn more about Docker? See link:https://dockerlabs.collabnix.com/beginners/components/container-vs-image.html[this page] for an explanation on the definitions of and the differences between images and containers.
