...
- For open-source projects hosted under the ASAM organization on Github.com all commits **must** include a sign-off message. See link:docs/project_guidelines/open-source/ASAM-DCO.md[Comitting to Open Source ASAM projects]
