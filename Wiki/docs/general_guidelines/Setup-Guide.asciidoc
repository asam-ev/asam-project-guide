...
This section provides information on how to install and configure Git. If you want to read more on how to work with Git, see link:../git/An-Introduction-to-Git.asciidoc[An Introduction To Git] and link:../git/Git-Best-Practices.md[Git-Best-Practices].
