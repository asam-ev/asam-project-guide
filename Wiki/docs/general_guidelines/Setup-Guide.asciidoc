...
VSCode has a lot of very helpful extensions that can be downloaded and installed through the integrated marketplace. For a list of recommended extensions, see the link::../tool-specific/VSCode-Guide.adoc[Visual Studio Code Guide].
