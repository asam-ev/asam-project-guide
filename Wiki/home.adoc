...
|image:Communication.png[Title=Teams & Sharepoint", width=120, link="docs/general_guidelines/Microsoft-Teams-and-Sharepoint.adoc"] +
link:docs/general_guidelines/Microsoft-Teams-and-Sharepoint.adoc[Teams & Sharepoint]
|image:Calendar.png[title="OpenX Calendar",width=120,link="docs/general_guidelines/Shared-OpenX-Calendar.adoc"] +
link:docs/general_guidelines/Shared-OpenX-Calendar.adoc[Shared Project Calendar]
| 

|<<Guidelines,**Guidelines**>>
|image:Workflow.png[title="Workflow Overview", width=120, link=docs/general_guidelines/Workflow.asciidoc] +
link:docs/general_guidelines/Workflow.asciidoc[Repository Guidelines]
|image:ProjectGuidelines.png[title="Project Guidelines", width=120, link=docs/general_guidelines/ProjectGuidelines.adoc] +
link:docs/general_guidelines/ProjectGuidelines.adoc[Project Guidelines]
|image:WritingGuideliens.png[alt="Writing Guidelines", width="120", link=docs/general_guidelines/WritingGuidelines.adoc] +
link:docs/general_guidelines/WritingGuidelines.adoc[Writing Guidelines]
| 

|<<Tools,**Tools**>> 
|image:https://cdn.icon-icons.com/icons2/2415/PNG/512/gitlab_original_logo_icon_146503.png[title="GitLab", width=120,link="docs/git/GitLabGuide.adoc"] + 
link:docs/git/GitLabGuide.adoc[GitLab Guide]
|image:https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Git_icon.svg/240px-Git_icon.svg.png[title="Git", width=120,link="docs/git/An-Introduction_to-Git.adoc"] + 
link:docs/git/An-Introduction_to-Git.adoc[Git Guide]
|image:https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/240px-Visual_Studio_Code_1.35_icon.svg.png[title="Visual Studio Code",width=120,link="docs/tool-specific/VSCode-Guide"] + 
link:docs/tool-specific/VSCode-Guide[VSCode Guide]
|image:https://dashboard.snapcraft.io/site_media/appmedia/2019/08/android-chrome-512x512.png[title="Draw.io",width=120,link="docs/tool-specific/DrawIOGuide.adoc"] +
link:docs/tool-specific/DrawIOGuide.adoc[Draw.io Guide]
