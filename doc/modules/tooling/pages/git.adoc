...
:keywords: git,summary,tool,mandatory
...
NOTE: xref:gitlab.adoc[GitLab] is the webhosted tool that provides a central hub and storage space (repository)and functions as remote for Git.
...
|xref:git/git-troubleshooting.adoc[image:{troubleshooting-image}[width=120,title="Git Troubleshooting"] Git Troubleshooting]
|xref:git/git-best-practices.adoc[image:{best-practices-image}[width=120,title="Git Best Practices"] Git Best Practices]

|===

reference::git,!summary