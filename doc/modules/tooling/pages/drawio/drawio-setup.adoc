...
== Prerequisites
* Local Setup (VSCode): xref:vscode.adoc[Visual Studio Code] is installed
...
include::compendium:page$vscode/extensions/drawio.adoc[leveloffset=+3]

NOTE: At this time, the VS Code extension does not provide url links to libraries. The only option to add the library is to download a copy and add it manually.
