...
include::compendium:page$tools/git/maintain-a-repo.adoc[{offset-value}]

include::compendium:page$tools/git/write-a-feature.adoc[{offset-value}]

include::compendium:page$tools/git/review-code.adoc[{offset-value}]
