...
== Prerequisites
* For direct integration: __{vscode}__ is installed
...
+
__**OPTIONAL**: If you would like to use __{vscode}__ as your standard Git editor, follow the optional instructions below.__
+
