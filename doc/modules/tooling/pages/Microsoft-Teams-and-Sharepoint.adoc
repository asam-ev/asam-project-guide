...
image::Communication.png[width=120,role=right]
...
NOTE: If you cannot access Teams after having been granted access by ASAM, check with your ASAM contact if you have already been assigned to any team or channel yet. You will receive an email from `noreply@email.teams.microsoft.com` when your account has been added to at least one channel.
...
image::Creating_a_meeting_in_teams.gif[Creating A Meeting In Teams]

=== Obtain The Email Address Of A Channel

include::partial$ObtainMailInTeams.adoc[]
...
include::partial$SharepointLinks.adoc[]
