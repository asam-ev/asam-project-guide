...
Depending on your role at __{asam}__, some tasks may require local software installation or may benefit from one.
...
For some of these, __{asam}__ provides a recommended base setup, listed under <<Recommended Tools>>.

NOTE: Since __{asam}__ does not develope those tools, descriptions and information on how to install, set up and use them is kept as short as possible to minimize outdated information in this guide as much as possible.

== Mandatory tools
TIP: Instead of installing software locally, __{asam}__ supports **{no-installation}** for some roles.
