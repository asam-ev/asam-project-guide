...
:keywords: docker,setup,task,fragment,docker-setup
:page-partial:
...
. __OPTIONAL: Add xref:compendium:vscode/extensions/docker.adoc[docker extensions] in xref:vscode.adoc[Visual Studio Code]__.
...
See link:https://docs.docker.com/engine/install/binaries/[window=_blank] for more information on this.
