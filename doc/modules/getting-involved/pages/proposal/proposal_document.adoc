...
The Project Proposal template is located in the https://code.asam.net/common/templates/proposal-template[ASAM GitLab^], where you can find more information on its structure and default content.
...
== Project Deliverables
The proposal must specify the deliverables it intends to hand over to ASAM at the end of the project.
Typically, this is a document for the standard plus an optional list of supplemental documents or models that will accompany the main document.
