...
The AsciiDoc extension for Visual Studio Code (see xref:tool-specific/Recommended-VSCode-Extensions.adoc#_asciidoc[Recommended Visual Studio Code Extensions]) comes with the ability to include Kroki diagrams. However, it is deactivated by default and must be configured before first use.
