...
:role-specific-nav-icon: xref:{role-specific-xref}[image:{role-specific-image}[width={width-nav-icon}] Tools Overview]
...
:standardization-nav-icon: xref:{standardization-xref}[image:{standardization-image}[width={width-nav-icon}] Tools Overview]
...
:compendium-nav-icon: xref:{compendium-xref}[image:{compendium-image}[width={width-nav-icon}] Tools Overview]
...
:project-guide-nav-icon: xref:{project-guide-xref}[image:{project-guide-image}[width={width-nav-icon}] Tools Overview]
