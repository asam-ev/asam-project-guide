...
//how-to
:tasks-image: https://cdn-icons-png.flaticon.com/512/4403/4403464.png
:tasks-xref: tasks:home.adoc
:tasks-icon: xref:{tasks-xref}[image:{tasks-image}[alt= How-To, width={width-large}, role=right]]
:tasks-icon-norole: xref:{tasks-xref}[image:{tasks-image}[alt= How-To, width={width-small}]]
...
:project-guide-xref: role-specific:home.adoc
