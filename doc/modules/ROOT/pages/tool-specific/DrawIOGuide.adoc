...
The local setup requires a local copy of the ASAM library. You can either check out the full link:{library-repo}[repository] or you can just download the library file directly (the .xml in the repository).
