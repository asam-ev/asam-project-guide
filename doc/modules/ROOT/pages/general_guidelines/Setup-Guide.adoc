...
*If you have already worked with Git, GitLab, and tools like Visual Studio Code, just set up your __GitLab account__, connect your __environment__ to it (or use the <<../tool-specific/GitLab-IDE_Guide.adoc[GitLab IDE]), and continue with the [.underline]#guidelines# in the Wiki's link:./Wiki/home.adoc#,Start Page>>.*
...
For more information on VSCode, see the <<:../tool-specific/VSCode-Guide.adoc#,Visual Studio Code Guide>>.

=== Git And Gitlab
ASAM uses <<../git/An-Introduction-to-Git.asciidoc#,Git>> for versioning projects and project files. GitLab is the webhosted tool that provides a central hub and storage space (repository). +
This section provides information on how to install and configure Git. If you want to read more on how to work with Git, see <<../git/An-Introduction-to-Git.asciidoc#,An Introduction To Git>> and <<../git/Git-Best-Practices.adoc#,Git-Best-Practices>>.
...
TIP: The following steps are tested with Microsoft Windows PowerShell. Instructions on how to open the PowerShell can be found <<../tool-specific/PowershellTutorial.adoc#,here>>.

. Open a <<../tool-specific/PowershellTutorial.adoc#,PowerShell>> window
...
. In a <<../tool-specific/PowershellTutorial.adoc#,PowerShell>> window, enter the following: 
+
NOTE: The <<../tool-specific/PowershellTutorial.adoc#,PowerShell>> window should be opened in your user folder (Windows). Usually, if you open it through right-click on the Windows button, this should be the case.
+
[source,git]
----
...
+
.. Open another <<../tool-specific/PowershellTutorial.adoc#,PowerShell>> window (with Administration rights)
...
+
NOTE: This should not be done in the Administration <<../tool-specific/PowershellTutorial.adoc#,PowerShell>> window if your Admin account is not your user account. Otherwise, Windows will complain about unprotected private key files!
+
.. Return to the PowerShell window or open a new one
...
For an example on how to work with VSCode and Git, see <<CloningRepoTutorial.adoc#,Cloning Your First Repository>>.
...
See <<../tool-specific/GitLab-IDE-Guide.adoc#,the GitLab Web IDE Guide>> for more information.

== See Also

* <<Platforms.adoc#,Overview over used platforms>>
* <<Microsoft-Teams-and-Sharepoint.adoc#,Teams & Sharepoint>>
* <<Shared-OpenX-Calendar.adoc#,Synchronize with the OpenX calendar>>
* <<../tool-specific/GitLab-IDE-Guide.adoc#,GitLab IDE Guide>>
* <<..tool-specific/VSCode-Guide.adoc#,Further VSCode Guide>>
* <<ProjectGuidelines.adoc#,Project Guidelines>>
* <<WritingGuidelines.adoc#,Writing Guidelines>>
* <<../git/An-Introduction-to-Git.asciidoc#,Git Introductions>>
* <<Getting-Docker.adoc#,How to install Docker (if required)>>
* <<../tool-specific/DockerGuide.adoc#,Docker Guide>>
* <<../writing_guidelines/Docker-For-Asciidoc.adoc#,Docker for AsciiDoc>>
