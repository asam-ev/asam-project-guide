...
TIP: The following steps are tested with Microsoft Windows PowerShell. Instructions on how to open the PowerShell can be found xref:../tool-specific/PowershellTutorial.adoc[here].

. Open a xref:../tool-specific/PowershellTutorial.adoc[PowerShell] window
...
. In a xref:../tool-specific/PowershellTutorial.adoc[PowerShell] window, enter the following: 
+
NOTE: The xref:../tool-specific/PowershellTutorial.adoc[PowerShell] window should be opened in your user folder (Windows). Usually, if you open it through right-click on the Windows button, this should be the case.
+
[source,git]
----
...
+
.. Open another xref:../tool-specific/PowershellTutorial.adoc[PowerShell] window (with Administration rights)
...
+
NOTE: This should not be done in the Administration xref:../tool-specific/PowershellTutorial.adoc[PowerShell] window if your Admin account is not your user account. Otherwise, Windows will complain about unprotected private key files!
+
.. Return to the PowerShell window or open a new one
...
For an example on how to work with VSCode and Git, see xref:{mydir}CloningRepoTutorial.adoc[Cloning Your First Repository].
...
* xref:git/An-Introduction-to-Git.asciidoc[Git Introductions]
