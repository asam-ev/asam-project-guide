...
IMPORTANT: Project files such as chapters, specifications, or images intended for use in the standard are to be handled through GitLab instead! See <<Workflow.asciidoc#,Workflow Guidelines>> for more information.
...
include::ObtainMailInTeams.adoc[]
