...
This summary assumes that you are using **Windows**. If not, check out  the <<{docker-download},official docker page>> for information on how to retrieve and install docker.

You can download Docker Desktop (the Docker version for Windows) <<{docker-download},here>>.
