...
:keywords: macro,extension,antora,asam,custom,project-guide, REVIEWED_TODO
...
== The Project Guide Antora playbook
The application of all applied extensions can be seen in the Project Guide's "site.yml" file.
...
Source file: {guide-repo-url}blob/main/site.yml[site.yml on GitHub]
