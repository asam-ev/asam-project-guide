...
- is responsible for the work group's progress and the final deliverables to __{asam}__
...
- create the deliverables to __{asam}__
...
. __{tsc}_ members review the written project report prior to the _{tsc}__ meeting.
...
. The project is put on the __{tsc}_ agenda, if either the project leader or a _{tsc}__ member request a live report.
