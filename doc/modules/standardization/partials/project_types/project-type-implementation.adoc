...
Goal:: The result of an implementation project can be a tool or source code, such as checkers for file formats and __{api}__s, add-ons or plug-ins for commonly used IDEs, importers, exporters or reference implementations.
