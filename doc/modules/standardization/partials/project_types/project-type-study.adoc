...
__{asam}__ may provides funding up to the limit for small budget projects.
//end::short[]
...
Upon request, __{asam}__ provides funding for study projects up to the limit for small budget projects.
