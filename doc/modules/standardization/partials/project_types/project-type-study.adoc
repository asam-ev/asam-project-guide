...
//tag::short[]
[horizontal]
Description:: Study projects provide members, particularly in regions, where ASAM standards are not well known, an organizational structure to study or analyze specific aspects of ASAM standards in a collaborative way.
