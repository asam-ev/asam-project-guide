...
The minimum deliverable of a concept project is a concept paper. __{asam}__ supports concept projects with funds of up to 75% of the total required project budget.
...
Upon request, __{asam}__ provides funding for concept projects up to 75% of the total required project budget.Concept projects are carried out via the standard development process.
