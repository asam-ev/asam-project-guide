...
xref:tooling:working-without-software-installation.adoc[Neither require any software installation], as they can be done directly through the xref:compendium:tools/gitlab/gitlab-ide_guide.adoc[Gitlab IDE]. +
