...
=== Standard user
include::compendium:page$roles/standard_user.adoc[tags=default;issue_resolution]

=== Standard manager
include::compendium:page$roles/standard_manager.adoc[tags=default;issue_resolution]

=== Standard expert group
include::compendium:page$roles/standard_expert-group.adoc[tags=default;issue_resolution]
