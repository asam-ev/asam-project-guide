...
The __{asam}__ organization is built around its members.
For more information, see the {asam-orga}[ASAM Website^].

== ASAM statutes
ASAM e.V. is built around statutes that define what __{asam}__ is, what its objectives are and what 'membership' means and implies.
It also specifies the organs and the management side of __{asam}__.
