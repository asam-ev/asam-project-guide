...
ifdef::any-button[]
This guide describes how to add the standard review button for both <<GitLab>> and <<GitHub>>.
endif::[]
ifdef::gitlab-button[]
This guide only describes how to add the standard review button for GitLab Service Desk.
endif::[]
ifdef::github-button[]
This guide only describes how to add the standard review button for GitHub.
endif::[]

== Result
A review button that is accessible on every page is added to the Antora topbar and linked to the respective repository.
...
include::compendium:partial$review_template_button.adoc[{button-attributes}]

== Troubleshooting / Known Issues
=== I want to add more features or a different template to my button
See xref:compendium:guides/reviews/add_custom_review_button.adoc[].
...
include::compendium:partial$review_template_button.adoc[tag=syntax]
...
include::compendium:partial$review_template_button.adoc[tag=mailto]
...
include::compendium:partial$review_template_button.adoc[tag=page-link]
