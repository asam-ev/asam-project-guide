...
:keywords: proposal-workshop, gameplan, READYFORREVIEW
...
== Timeline to an approved project proposal

image::compendium:proposal_workshop_timeline.drawio.svg[]
// Disucssion: Should this image be moved to the standardization module instead?
// Or is this actually better suited for the Compendium?
...
* the xref:standardization:project-types.adoc[project type]
|===
