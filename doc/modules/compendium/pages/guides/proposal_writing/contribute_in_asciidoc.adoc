...
The repository-based approach of __{asam}__ for working on documents allows members to work in parallel on the same documents without the risk of overwriting each others changes without notice.
