...
ISO/IEC Directives, Part 2, Principles and rules for the structure and drafting of ISO and IEC documents, 9th edition, 2021, 9.1 Representation of numbers and numerical values
...
[#sec-ASM-75]
=== Use manual line breaks sparingly (ASM-75)
...
.Use of manual line breaks
[%header, col=2*]
|===
|No
|#Yes#

|[.line-through]#After this sentence a line break is needed.
...
ASAM Writing Guide: XIL: Manual line breaks
...
[#sec-ASM-78]
=== Insert a unique ID for topics, sections, figures, tables and code examples (ASM-78)

* `[#top-<uid>]` for topics

* `[#sec-<uid>]` for sections
...
[#sec-ASM-79]
=== Use four space characters per indentation level (ASM-79)

NOTE: Why ist this needed? Is it for asciidoc oder other source code?
...
[#sec-ASM-117]
=== Use underscore '__' instead of space '  ' in file and folder names (ASM-117)
