...
[#sec-ASM-113]
=== Use the modal verb _may (not)_ to express a permission (ASM-113)
...
|===
|No                                         |#Yes#
|[.line-through]#it is not allowed to have# |it may not have
|===
...
TODO: How to format a heading using asciidoc?
////
...
Insert an empty line to create a new paragraph.
...
|===
|No                                                                                                      |#Yes#
|[.line-through]#This is a first thought. And this deepens the first thought. This is a second thought.# |This is a first thought. And this deepens the first thought.

 This is a second thought.
|===
...
[#sec-ASM-xx]
=== Use AsciiDoc syntax for source code snippets (ASM-xx)
...
Optional: Use the words "element" or "elements".
...
[#sec-ASM-46]
=== Create an ID with a UUID for every table (ASM-46)
...
Every chapter has an "images" folder that contains all the images of the chapter and the sections of the chapter.
...
[#sec-ASM-xx]
=== Create an ID with a UUID for every figure (ASM-)
...
Decorative images shall not have a description; for example, the ASAM logo.
...
* The number of the image, "figure 58", is automatically referenced.
...
[#sec-ASM-118]
=== Use '.adoc' as file extension for documents (ASM-118)
...
[#sec-ASM-119]
=== Use PlantUML (*.puml) for UML diagrams (ASM-119)
