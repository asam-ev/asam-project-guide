...
|===
|No                                                                                                                                         |#Yes#
|[.line-through]#Unless stated otherwise, all examples, figures and descriptions in this specification assume there is right-hand traffic.# |Unless stated otherwise, all examples, figures, and descriptions in this specification assume there is right-hand traffic.
|[.line-through]#Pages, colors, traces are all copied from the display.#                                                                    |Pages, colors, and traces are all copied from the display.
|===
...
|===
|No|#Yes#
|[.line-through]#In the ASAM OpenSCENARIO data model these types are used:#                               |In the ASAM OpenSCENARIO data model, these types are used:
|[.line-through]#To find the mismatches we propagate the expected type backwards through the expression.# |To find the mismatches, we propagate the expected type backwards through the expression.
|===
...
|===
|No                                                                             |#Yes#
|[.line-through]#This is basically a good rule that actually helps very often.# |This is a good rule that helps.
|===
...
|===
|No                                                                                                                    |#Yes#
|[.line-through]#Due to the fact that they were able to come to an agreement, a name changing of the file took place.# |They agree and rename the file.
|===
...
|===
|No                                                                       |#Yes#
|[.line-through]lateral and/or longitudinal#                              |lateral, longitudinal, or both
|[.line-through]#segment continuity, tangent and/or curvature continuity# |segment continuity, tangent, curvature continuity, or all of them
|===
...
|===
|No                                                                                                  |#Yes#
|[.line-through]#Press and hold the key. Wait 2 seconds. Release the button. Push the button again.# |Press and hold the key. Wait 2 seconds. Release the key. Press the key again.
|===
...
|===
|No                                                          |#Yes#
|[.line-through]#The car that is red drives down the road.#  |The car, which is red, drives down the road.
|[.line-through]#The car which is red drives down the road.# |The car, which is red, drives down the road.
|===
...
|===
|No                                                                                   |#Yes#
|[.line-through]#The system cannot calculate a result because of yesterday's events.# |The system cannot calculate a result since yesterday.
|===
...
If you refer to the *standard you are working on*, see <<#sec-ASM-120>>.
...
|===
|No                                                                                   |#Yes#
|[.line-through]#``This is wrong with whitespace.   &nbsp;&nbsp;&nbsp;         [EOL]``#|``This is correct.[EOL]``
|===
...
Restructure the document to avoid headings with levels greater 4.
...
|===
|No                                     |#Yes#
|[.line-through]#`+++===== Heading+++`# |`+++==== Heading (level 4)+++` +
                                         `+++==== Heading (level 4)+++`
|===
...
|===
|No                                                               |#Yes#
|[.line-through]#``+++== 13. Wrong numbering in a heading+++``#   |``+++== Correct heading without numbering+++``
|[.line-through]#``+++=== 14.3 Wrong numbering in a heading+++``# |``+++=== Correct heading without numbering+++``
|[.line-through]#``+++==== 14.3.a) Wrong numbering in a heading+++``# |``+++==== Correct heading without numbering+++``
|===
...
|===
|No                                                                                                      |#Yes#
|[.line-through]#This is a first thought in the first paragraph. And this deepens the first thought. This is a second thought in the following paragraph.# |This is a first thought in the first paragraph. And this deepens the first thought.
...
|* This is the first sentence. +
pass:[*] This is the second sentence. +
pass:[*] This is the third sentence.
|===
...
|* Common junctions +
pass:[*] Direct junctions +
pass:[*] Virtual junctions
|===
...
[#sec-ASM-92]
=== Use one folder "images" per chapter (ASM-92)

Every chapter has an "images" folder that contains all the figures of the chapter and the sections of the chapter.
...
[#sec-ASM-78]
=== Insert a unique ID for topics, figures, tables, source code, and sections (ASM-78)
...
// NOTE: Where to use a semantic ID and where a UUID? What are allowed characters in IDs anyway? How about a Regex for a valid ID production: [a-zA-Z0-9_-]
...
// TODO: Missing rule ASM-18: LOF created automatically
// TODO: Missing rule ASM-19: LOT created automatically
