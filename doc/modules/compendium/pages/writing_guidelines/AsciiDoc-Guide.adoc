...
TIP: Use the inline macro when you add text before and/or after the macro. Otherwise, use the standard macro.

== Admonitions: Notes, tips, etc.

You might want to draw attention to certain statements by creating notes or tips - so-called admonitions. Format them as follows:
