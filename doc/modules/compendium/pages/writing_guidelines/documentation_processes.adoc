...
GitLab issues that are documentation related are created by working group members and technical writers.
...
* If a GitLab issue is ready for creating content for the documentation, the working group members assign the `isReadyForServiceProvider` label to the issue.
...
The technical writer presents the changes to the working group members.
* If the changes are accepted by the working group members, the GitLab issue is closed.
* If there are objections regarding a change to the documentation, a new iteration process starts.
Objections are communicated by the working group members and added as comments to the GitLab issue.
...
Working group members and technical writers shall apply the rules when creating documentation for ASAM.
This section contains information on how to create and apply editorial rules.

=== Using editorial rules

. Provide the ASAM Editorial Guide to working group members and technical writers when a project starts.
. Working group members should try to apply the editorial rules.
. Technical writers may educate working group members who do not apply the editorial rules.
. Technical writers shall review the content committed by working group members as soon as possible.
