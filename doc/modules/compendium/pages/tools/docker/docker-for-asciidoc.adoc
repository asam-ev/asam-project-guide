...
If the layout and final look is important, you should create the HTMl output from the adoc files by using the asciidoctor docker container (configured in the xref:compendium:tools/docker/standard-docker-config.adoc[standard docker-compose.yml]).
