...
:keywords: proposal, document, TODO
...
== Result
A valid Project Proposal is created that can be brought to decision by the __{tsc}__.
...
NOTE: The sections 'Project Ressources' and 'Project Plan' will be filled out at a later stage and do not need to be edited in this draft.
