...
* See xref:getting-involved:home.adoc[] for information on participating in __{asam}__ standardization.
* The xref:role-specific:home.adoc[] part collects typical tasks and important topics by __{asam}__ roles.
* If you want to learn more about the processes used in __{asam}__ standardization, see xref:standardization:home.adoc[].
